...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/Qt5Charts" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Charts_install_prefix "/usr/lib/x86_64-linux-gnu/../../" ABSOLUTE)
else()
...
set(Qt5Charts_VERSION_STRING 5.7.0)
...
macro(_populate_Charts_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5Charts_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Charts)
    ...
    set(_Qt5Charts_OWN_INCLUDE_DIRS "${_qt5Charts_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5Charts_install_prefix}/include/x86_64-linux-gnu/qt5/QtCharts")
    set(Qt5Charts_PRIVATE_INCLUDE_DIRS
        "${_qt5Charts_install_prefix}/include/x86_64-linux-gnu/qt5/QtCharts/5.7.0"
        "${_qt5Charts_install_prefix}/include/x86_64-linux-gnu/qt5/QtCharts/5.7.0/QtCharts"
    )
    ...
    foreach(_module_dep ${_Qt5Charts_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.7.0 ${_Qt5Charts_FIND_VERSION_EXACT}
    ...
    _populate_Charts_target_properties(RELEASE "libQt5Charts.so.5.7.0" "" FALSE)
    ...
    macro(_populate_Charts_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Charts_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Charts_check_file_exists(${imported_location})
