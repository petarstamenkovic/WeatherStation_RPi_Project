...
QT_INIT_METAOBJECT const QMetaObject QtCharts::QChartView::staticMetaObject = { {
    QMetaObject::SuperData::link<QGraphicsView::staticMetaObject>(),
    qt_meta_stringdata_QtCharts__QChartView.data,
    qt_meta_data_QtCharts__QChartView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
