...
#include <memory>
#include "../axis/datetimeaxis/chartdatetimeaxisx_p.h"
...
void QtCharts::ChartDateTimeAxisX::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ChartDateTimeAxisX *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QtCharts::ChartDateTimeAxisX::staticMetaObject = { {
    QMetaObject::SuperData::link<HorizontalAxis::staticMetaObject>(),
    qt_meta_stringdata_QtCharts__ChartDateTimeAxisX.data,
    qt_meta_data_QtCharts__ChartDateTimeAxisX,
    qt_static_metacall,
    nullptr,
    nullptr
} };
