...
#include <memory>
#include "../axis/logvalueaxis/chartlogvalueaxisx_p.h"
...
void QtCharts::ChartLogValueAxisX::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ChartLogValueAxisX *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QtCharts::ChartLogValueAxisX::staticMetaObject = { {
    QMetaObject::SuperData::link<HorizontalAxis::staticMetaObject>(),
    qt_meta_stringdata_QtCharts__ChartLogValueAxisX.data,
    qt_meta_data_QtCharts__ChartLogValueAxisX,
    qt_static_metacall,
    nullptr,
    nullptr
} };
