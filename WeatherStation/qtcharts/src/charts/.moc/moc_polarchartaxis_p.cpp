...
QT_INIT_METAOBJECT const QMetaObject QtCharts::PolarChartAxis::staticMetaObject = { {
    QMetaObject::SuperData::link<ChartAxisElement::staticMetaObject>(),
    qt_meta_stringdata_QtCharts__PolarChartAxis.data,
    qt_meta_data_QtCharts__PolarChartAxis,
    qt_static_metacall,
    nullptr,
    nullptr
} };
