...
void QtCharts::PolarChartCategoryAxisRadial::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PolarChartCategoryAxisRadial *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QtCharts::PolarChartCategoryAxisRadial::staticMetaObject = { {
    QMetaObject::SuperData::link<PolarChartAxisRadial::staticMetaObject>(),
    qt_meta_stringdata_QtCharts__PolarChartCategoryAxisRadial.data,
    qt_meta_data_QtCharts__PolarChartCategoryAxisRadial,
    qt_static_metacall,
    nullptr,
    nullptr
} };
