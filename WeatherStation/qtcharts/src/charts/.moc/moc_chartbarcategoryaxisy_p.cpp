...
void QtCharts::ChartBarCategoryAxisY::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ChartBarCategoryAxisY *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QtCharts::ChartBarCategoryAxisY::staticMetaObject = { {
    QMetaObject::SuperData::link<VerticalAxis::staticMetaObject>(),
    qt_meta_stringdata_QtCharts__ChartBarCategoryAxisY.data,
    qt_meta_data_QtCharts__ChartBarCategoryAxisY,
    qt_static_metacall,
    nullptr,
    nullptr
} };
