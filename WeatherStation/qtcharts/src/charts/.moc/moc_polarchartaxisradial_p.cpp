...
#include <memory>
#include "../axis/polarchartaxisradial_p.h"
...
QT_INIT_METAOBJECT const QMetaObject QtCharts::PolarChartAxisRadial::staticMetaObject = { {
    QMetaObject::SuperData::link<PolarChartAxis::staticMetaObject>(),
    qt_meta_stringdata_QtCharts__PolarChartAxisRadial.data,
    qt_meta_data_QtCharts__PolarChartAxisRadial,
    qt_static_metacall,
    nullptr,
    nullptr
} };
